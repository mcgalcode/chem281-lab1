...
To check out that version of the code, navigate into the repo after you clone it, and run:

```
git checkout 8832a79
```

This command causes us to revert to a previous version of the code (i.e. the one that we know works for our simulation).
